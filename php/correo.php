...
<center>
<table class="row header" style="background-color: lime">
<tr>
...
<img src="http://www.lantalks.com/mailing/loop/img/brand-01.png" height="40px">
</td>
...
<td>
<h1>¡Hola!</h1>
<p class="lead">Este es un mensaje que proviene del sitio web de Loop Radio. Enviado por '. $_POST["nombre"] .' (Correo: '. $_POST["correo"].')</p>
<p>'.$_POST['mensaje'].'</p>
</td>
<td class="expander"></td>
</tr>
...
<tr>
<td class="panel">
<p><strong>Atención</strong> Este correo fue generado automáticamente desde el sitio de Loop Radio. </p>
</td>
<td class="expander"></td>
</tr>
</table>
...
<tr>
<td>
<a href="http://www.facebook.com/radiorocksf">Facebook</a>
</td>
</tr>
</table>
<br>
...
<tr>
<td>
<a href="http://www.twitter.com/loopradiook">Twitter</a>
</td>
</tr>
</table>
</td>
...
<p>Un medio de Lantalks WebMedia</p>
</td>
<td class="expander"></td>
</tr>
</table>
...
<td class="expander"></td>
	...
	$asunto = "[Loop Radio] Mensaje de ". $_POST['nombre'] .".";
	$encabezados = 'MIME-Version: 1.0' . "\r\n";
	$encabezados .= 'Content-type: text/html; charset=UTF-8' . "\r\n";
	$encabezados .= 'From: '.$_POST['correo'];

	mail($destino, $asunto, $mensaje, $encabezados);
	echo $destino, $asunto, $mensaje, $encabezados; 
?>