...
var datosRadio = function(options) {

    var defaults = {
        updatePeriod: 5, //seconds
        sourceDomain: "http://localhost/", //where to get show status from
        text: {onAirNow:"En el aire", offline:"Fuera del aire", current:"Current", next:"Next"}
    };
    ...
    options.sourceDomain = addEndingBackslash(options.sourceDomain);
        ...
        function updateWidget(){
            ...
            //obj.empty();
            estadoRadio = showStatus; 
            temaActual = sd.currentTrack.getTitle(); 
